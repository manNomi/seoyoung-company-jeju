...
const planAItinerary = {
  1: {
    ...
    items: [
      ...
      { time: "+10분", name: "고래휴게소 표선점", category: "원안 저녁", description: "PDF에 적힌 표선 쪽 저녁 후보예요.", meta: ["차량 이용 표기", "당일 영업 확인"], query: "고래휴게소 표선점" },
      ...
      { time: "+12분", name: "사부작", category: "원안 예약", description: "PDF의 예약제 저녁 후보예요. 예약 시간과 영업일이 맞을 때만 이용해요.", meta: ["예약 가능 표기", "PDF 원안"], query: "사부작 제주 표선" },
...
const recommendations = [
  ...
  { region: "east", name: "섭섭이네", tags: ["구좌", "로컬 식당"], time: "60분", detour: "송당리 1379-13", description: "구좌에서 든든한 한 끼를 책임지는 로컬 식당이에요. 비밀의숲이나 송당 동선의 식사 장소로 묶기 좋아요.", query: "제주 제주시 구좌읍 송당리 1379-13 섭섭이네" },
  { region: "east", name: "비밀의숲", tags: ["구좌", "삼나무 숲길"], time: "60분", detour: "송당리 2173", description: "곧게 뻗은 삼나무 숲길을 따라 걷는 제주 동쪽 대표 힐링 스팟이에요. 비가 강하거나 바람이 센 날에는 숲길 진입을 피하세요.", query: "제주 제주시 구좌읍 송당리 2173 비밀의숲" },
  { region: "east", name: "차한모금", tags: ["구좌", "숲속 카페"], time: "60분", detour: "평대리 3193-1", description: "시원한 빙수와 차 한 잔을 즐기기 좋은 숲속 감성 카페예요. 비자림이나 평대리 일정의 휴식 지점으로 좋아요.", query: "제주 제주시 구좌읍 평대리 3193-1 차한모금" },
  { region: "east", name: "섭지코지", tags: ["성산", "대표 절경"], time: "60분", detour: "성산읍 고성리", description: "푸른 초원과 에메랄드빛 바다가 만나는 제주 동쪽 대표 절경이에요. 강풍이나 호우가 있으면 방문하지 마세요.", query: "제주 서귀포시 성산읍 고성리 섭지코지", source: "https://www.visitjeju.net/kr/search?q=%EC%84%AD%EC%A7%80%EC%BD%94%EC%A7%80&searchtype=2" },
  { region: "east", name: "온평바다한그릇", tags: ["성산", "해산물 식당"], time: "60분", detour: "온평리 1192-1", description: "성게와 전복 및 딱새우를 한 그릇에 담아낸 제주 해산물 식당이에요. 삼달리 숙소와 가까운 식사 후보로 넣기 좋아요.", query: "제주 서귀포시 성산읍 온평리 1192-1 온평바다한그릇" },
  { region: "east", name: "카페구할구", tags: ["월정리", "감성 카페"], time: "50분", detour: "월정리 514", description: "월정리 골목에서 조용히 쉬기 좋은 감성 카페예요. 월정리해변이나 코난해변과 함께 묶을 수 있어요.", query: "제주 제주시 구좌읍 월정리 514 카페구할구" },
  { region: "east", name: "코난해변", tags: ["구좌", "포토스팟"], time: "30분", detour: "행원리 575-6", description: "에메랄드빛 바다 덕분에 제주의 코난 해변이라 불리는 포토스팟이에요. 월정리해변과 가까워 둘 중 한 곳만 골라도 좋아요.", query: "제주 제주시 구좌읍 행원리 575-6 코난해변" },
  { region: "east", name: "여름문구사", tags: ["세화", "문구와 소품"], time: "40분", detour: "세화리 1397-6", description: "제주 감성을 담은 문구와 소품을 만날 수 있는 아기자기한 문구샵이에요. 세화해변 산책과 함께 들르기 좋아요.", query: "제주 제주시 구좌읍 세화리 1397-6 여름문구사" },
...
const rainItinerary = {
  ...
  2: {
    ...
    items: [
      ...
      { time: "14:30", name: "서툰가족", category: "선택 코스", description: "사용자가 저장해 둔 비 오는 날 후보예요. 정확한 지점과 영업 여부를 지도에서 확인한 뒤 성산권일 때만 들러요.", meta: ["장소 확인 필요", "동선 밖이면 생략"], query: "서툰가족 제주", map: false, alert: true },
