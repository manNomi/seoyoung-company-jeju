const itinerary = {
  1: {
    ...
    items: [
      { time: "15:15", name: "제주공항 도착", category: "도착", description: "렌터카를 인수하고 제주시로 이동해요.", meta: ["렌터카 이동", "여유 30분"], query: "제주국제공항" },
      ...
      { time: "20:00", name: "숙소로 이동", category: "휴식", description: "일몰과 교통 상황에 맞춰 무리하지 않고 숙소로 돌아가요.", meta: ["체크인 주소 확인", "다음 날 짐 정리"], query: "제주 숙소", map: false }
    ]
  },
  2: {
    note: "기존 일정은 서귀포에서 세화로 갔다가 다시 중문으로 돌아와 실제 도로 이동이 과도했어요. 동쪽에서 시작해 사계리로 한 방향만 이동하도록 줄였습니다.",
    items: [
      ...
      { time: "13:00", name: "동쪽 점심 식사", category: "식사", description: "김녕이나 조천에서 식사한 뒤 서귀포 방향으로 한 번에 이동해요.", meta: ["주차 가능한 식당", "14시 전 출발"], query: "제주 김녕 맛집", map: false },
      { time: "15:30", name: "친봉산장", category: "카페", description: "중산간을 가로질러 상효동의 산장형 카페에서 쉬어요.", meta: ["하신상로 417", "당일 영업 확인"], query: "친봉산장 제주" },
      { time: "17:40", name: "돈사빠", category: "저녁", description: "사계리 숙소로 가는 길에 흑돼지 저녁을 먹어요.", meta: ["영업시간 확인", "마감 주문 확인"], query: "돈사빠 제주" },
      { time: "19:30", name: "서툰가족 체크인", category: "예약 숙소", description: "사계리의 예약 숙소에서 하루를 마무리해요.", meta: ["예약자 주소 확인", "관광지 아님"], query: "서툰가족 제주" }
    ]
  },
  3: {
    note: "귀가편 시간이 확인되지 않아 오전 선택 코스로 구성했어요. 비행기가 오후 4시 이전이면 유동룡미술관과 슬로보트를 모두 빼고 바로 공항으로 이동하세요.",
    items: [
      { time: "08:30", name: "체크아웃과 아침 식사", category: "준비", description: "숙소 근처에서 아침을 먹고 항공편 시간을 다시 확인해요.", meta: ["짐 먼저 싣기", "비행 5시간 전 판단"], query: "제주 사계리 아침", map: false },
...
const rainItinerary = {
  1: {
    ...
    items: [
      { time: "15:15", name: "제주공항 도착", category: "도착", description: "렌터카를 인수하고 젖은 노면을 고려해 천천히 이동해요.", meta: ["우산을 바로 꺼내기", "제동목장은 다음날 새벽"], query: "제주국제공항" },
      ...
      { time: "20:00", name: "숙소 체크인", category: "휴식", description: "젖은 옷과 신발을 말리고 다음날 새벽 출발을 준비해요.", meta: ["05:30 기상", "우비와 수건 준비"], query: "제주 숙소", map: false }
    ]
  },
  2: {
    note: "8월 17일은 월요일이라 올데이모즈와 유동룡미술관을 고정 일정에서 제외했어요. 낙뢰나 호우가 이어지면 사려니숲길도 취소하고 연중무휴인 아르떼뮤지엄부터 시작하세요.",
    items: [
      ...
      { time: "12:00", name: "서쪽으로 이동", category: "이동", description: "애월까지 빗길 기준으로 넉넉하게 시간을 잡고 한 번에 이동해요.", meta: ["약 60분에서 80분", "침수 도로 우회", "중간 관광 생략"], query: "아르떼뮤지엄 제주", map: false },
      { time: "13:30", name: "아르떼뮤지엄 제주", category: "실내 전시", description: "연중무휴 실내 전시에서 비가 강한 오후를 보내요.", meta: ["10시부터 20시", "입장 마감 19시", "약 90분"], query: "아르떼뮤지엄 제주" },
      { time: "15:40", name: "바이닐 제주", category: "음악 카페", description: "자리별 턴테이블로 LP를 들으며 빗소리와 바다를 함께 즐겨요.", meta: ["한림읍 옹포리 643", "약 80분", "입장 요금 확인"], query: "바이닐 제주" },
      { time: "17:40", name: "돈사빠", category: "저녁", description: "대정읍으로 내려가 흑돼지 저녁을 먹어요. 비 오는 저녁이라 대기와 주차 상황을 미리 확인해요.", meta: ["중산간서로 2405", "15시 이후 영업 확인", "마감 주문 확인"], query: "돈사빠 제주" },
      { time: "19:30", name: "서툰가족 체크인", category: "예약 숙소", description: "사계리의 예약 숙소로 이동해 젖은 옷과 신발을 말리며 하루를 마무리해요.", meta: ["숙박 예약 필수", "정확한 체크인 주소 확인", "관광지 아님"], query: "서툰가족 제주" }
    ]
  },
  3: {
    note: "비행기가 오후 4시 이후일 때만 유동룡미술관과 슬로보트를 이용하세요. 강풍이나 운항 변동이 있으면 두 곳 모두 생략하고 공항으로 이동해야 해요.",
    items: [
      { time: "08:30", name: "체크아웃과 운항 확인", category: "준비", description: "젖은 짐을 분리하고 항공편과 도로 상황을 먼저 확인해요.", meta: ["비닐봉투 준비", "비행 5시간 전 판단"], query: "제주공항 운항정보", map: false },
      { time: "10:00", name: "유동룡미술관", category: "실내 전시", description: "화요일 오전에 예약 가능한 경우에만 방문해요.", meta: ["10시 개관", "사전 예약 확인", "약 80분"], query: "유동룡미술관" },
      { time: "11:50", name: "슬로보트", category: "카페", description: "공항 방향 하귀리에서 바다를 보며 짧게 쉬어요.", meta: ["하귀1리 330", "당일 영업 확인", "60분 이내"], query: "슬로보트 제주" },
...
const rainRecommendations = [
  ...
  { region: "west", name: "플레이사계시장", tags: ["시장", "사계리"], time: "60분", detour: "사계리 126-1", description: "서툰가족 숙소와 돈사빠 동선에서 함께 확인하기 좋은 사계리 후보예요. 운영일을 먼저 확인하세요.", query: "플레이사계시장" },
  ...
  { region: "west", name: "서툰가족", tags: ["예약 숙소", "사계리"], time: "숙박", detour: "산방산 인근", description: "관광지가 아닌 독채 숙소예요. 예약자만 정확한 주소와 체크인 안내를 확인한 뒤 이동하세요.", query: "서툰가족 제주" }
];
...
function renderTimeline() {
  const plan = activeMode === "rain" ? rainItinerary : itinerary;
  const day = plan[activeDay];
  const dayLabels = activeMode === "rain"
    ? ["도착과 실내 동선", "사려니에서 사계까지", "서쪽에서 공항까지"]
    : ["제주시에서 교래까지", "동쪽에서 사계까지", "서쪽에서 공항까지"];
  timeline.innerHTML = `
    ...
    const id = activeMode === "rain" ? `rain-${activeDay}-${index}` : `${activeDay}-${index}`;
    const isDone = Boolean(completed[id]);
    return `
      <article class="timeline-item">
        <time class="time">${item.time}</time>
        <span class="timeline-dot" aria-hidden="true"></span>
        <div class="place-card ${isDone ? "completed" : ""}">
          <div>
          ...
          <div class="place-actions">
            <a class="map-link" href="${mapUrl(item.query)}" target="_blank" rel="noreferrer">지도 열기</a>
...
function renderRouteInsight(day, activeIndex) {
  ...
  document.querySelector("#mapInsightPanel").innerHTML = `
    <div class="map-panel-topline"><span>${activeMode === "rain" ? "RAIN ROUTE" : "DAY ROUTE"}</span><b>${day.items.length} STOPS</b></div>
...
function renderClusterView() {
  if (!ensureTrekMap()) return;
  clearTrekMapLayers();
  const source = activeMode === "rain" ? rainRecommendations : recommendations;
...
function updateProgress() {
  const plan = activeMode === "rain" ? rainItinerary : itinerary;
  const prefix = activeMode === "rain" ? "rain-" : "";
  const total = Object.values(plan).reduce((sum, day) => sum + day.items.length, 0);
  const done = Object.entries(completed).filter(([key, value]) => value && (activeMode === "rain" ? key.startsWith(prefix) : !key.startsWith("rain-"))).length;
...
function setPlanMode(mode) {
  ...
  document.querySelector(".trek-page").classList.toggle("rain-mode", mode === "rain");
  document.querySelectorAll("[data-plan-mode]").forEach(button => {
    const isActive = button.dataset.planMode === mode;
    button.classList.toggle("active", isActive);
    button.setAttribute("aria-pressed", String(isActive));
  });
  document.querySelector("#heroStatusText").textContent = mode === "rain" ? "Rain backup" : "Upcoming";
  document.querySelector("#planTitle").textContent = mode === "rain" ? "비 오는 날 일정" : "여행 일정";
  document.querySelector("#planDescription").textContent = mode === "rain" ? "비가 그친 새벽과 약한 비 및 호우 상황을 나눠 안전하게 다시 구성했어요." : "PDF에 적어둔 순서대로 정리했어요. 방문한 장소는 체크해 둘 수 있어요.";
  document.querySelector("#weatherIcon").textContent = mode === "rain" ? "☂" : "☀";
  document.querySelector("#weatherSummary").textContent = mode === "rain" ? "비의 강도 확인" : "한여름 제주";
  document.querySelector("#weatherDetail").textContent = mode === "rain" ? "호우와 강풍이면 실내로 전환" : "덥고 습하며 소나기 가능";
  document.querySelector("#focusSummary").textContent = mode === "rain" ? "조천에서 한림과 사계" : "제주 동쪽";
  document.querySelector("#focusDetail").textContent = mode === "rain" ? "숲과 카페 및 실내 전시" : "바다와 숲 중심 일정";
  document.querySelector("#recommendationTitle").textContent = mode === "rain" ? "비의 강도별 대안" : "동선 근처 추천";
  document.querySelector("#recommendationDescription").textContent = mode === "rain" ? "야외 장소는 비가 그친 뒤에만 선택하고 호우에는 실내 장소로 바꿔요." : "일정을 크게 흔들지 않는 장소만 모았어요.";
  const dayDescriptions = mode === "rain"
    ? ["도착과 실내 동선", "사려니에서 사계까지", "서쪽에서 공항까지"]
    : ["제주시에서 교래까지", "동쪽에서 사계까지", "서쪽에서 공항까지"];
  document.querySelectorAll(".day-tab > div > small").forEach((element, index) => { element.textContent = dayDescriptions[index]; });
  const activePlan = mode === "rain" ? rainItinerary : itinerary;
  ...
  quickLinks.innerHTML = mode === "rain" ? `
    ...
    <a href="${mapUrl("유동룡미술관")}" target="_blank" rel="noreferrer"><span>□</span><div><strong>유동룡미술관</strong><small>예약과 운영 확인</small></div><b>↗</b></a>` : `
    ...
    <a href="${mapUrl("중문회어시장")}" target="_blank" rel="noreferrer"><span>♨</span><div><strong>중문회어시장</strong><small>포장 후보</small></div><b>↗</b></a>`;
